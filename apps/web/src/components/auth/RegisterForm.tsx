          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                <div className="relative">
                  <UserCheck className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-600" />
                  <Input 
                    id="confirmPassword"
          ...
          <div className="bg-gray-100 relative hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-primary/5 to-background flex items-center justify-center">
              <div className="text-center space-y-4 p-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Join Claro Today</h2>
                <p className="text-gray-600 max-w-sm">
                  Start your journey with powerful project management tools designed for modern teams.
                </p>
              </div>
            </div>
          </div>
